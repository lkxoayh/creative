...
def creatorpage_disco(creator_id):
    from requests.structures import CaseInsensitiveDict

    url = f"https://fn-service-discovery-live-public.ogs.live.on.epicgames.com/api/v2/discovery/surface/CreativeDiscoverySurface_CreatorPage?appId=Fortnite&stream=%2B%2BFortnite%2BRelease-{version}"
    ...
    data = {
        "pagePlayerId": creator_id,
        "playerId": "1cf9d8e3f28f4f79934c4189adcb42f0",
        "partyMemberIds": ["1cf9d8e3f28f4f79934c4189adcb42f0"],
        "accountLevel": 214,
        "battlepassLevel": 5,
        "locale": "en",
        "matchmakingRegion": "EU",
